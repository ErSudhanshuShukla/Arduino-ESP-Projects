...
- 🎮 **Fun_Games_Visuals** – Dino Game, Piano, LED Chaser, Music Rhythm Lights, Traffic Lights, etc.
- 🏠 **Home_Automation** – Smart Door, Automatic Street Light, Clap Switch, Touch Sensor Light, etc.
- 📏 **Measurement_Monitoring** – Air Quality Monitor, Distance Meter, Weather Station, Sound Level Meter, Speed Measurement, etc.  
- 🤖 **Robotics_Vehicles** – Bluetooth Car, Obstacle Avoiding Car, Wired Joystick Car, RFID Toll System, Smart Parking, etc.    
